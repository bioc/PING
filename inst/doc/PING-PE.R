...
###################################################
segPE<-segmentPING(gr,  chr="chrM", islandDepth=3, min_cut=50, max_cut=1000, PE=TRUE)
...
###################################################
### code chunk number 9: makeRangedDataOutput (eval = FALSE)
###################################################
...
###################################################
### code chunk number 10: plotSummary-PE
###################################################
plotSummary(PS, gr, chr="chrM", from=1000, to=4000)
